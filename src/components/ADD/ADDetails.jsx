...
const Details = ({ subCategory, subSubCategory, details, handleChange }) => {
  ...
  <h2 className="text-2xl font-semibold mb-6">Product Details</h2>
            ...
            .filter(
              (os) =>{ 
               if( subSubCategory === "Mac Book Pc" ){ 
                  return os.toLowerCase().includes("macos");
                }
                else{ 
                  return !os.toLowerCase().includes("macos");
                }
    ...
    { ["keyboard", "Mouse", "Headphones Pc"].includes(subSubCategory) &&  (
     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
       {/* Type  */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          >
            ...
            {["32G", "64G", "128G", "256G", "512G"].map((Storage, index) => (
    ...
    { subSubCategory === 'Charger' && (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {details.fastCharger && (
          ...
          <select
            name="speedCharger"
            value={details.speedCharger || ""}
            onChange={handleChange}
            className="w-full p-2 border rounded-md focus:outline-blue-500"
          >
            <option value="" disabled>Select Fast Charger</option>
            {["15W", "20W", "25W", "30W", "40W", "50W", "60W", "65W", "70W", "80W", "90W", "100W"].map((power, index) => (
    ...
    <p className="mt-4 text-gray-600">
      Total Description Items: {numberDesItem}
    </p>
